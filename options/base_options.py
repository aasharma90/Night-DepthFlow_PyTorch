...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataname', required=True, type=str, 
            help='name of the dataset to check the model on?')
        self.parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints', 
            help='models are saved here')
        self.parser.add_argument('--trn_datafile1', required=True, type=str, 
            help='list containing trn images from dom1')
        self.parser.add_argument('--trn_datafile2', required=True, type=str, 
            help='list containing trn images from dom2')
        self.parser.add_argument('--val_datafile1', required=True, type=str,
            help='list containing val images from dom1')
        self.parser.add_argument('--n_domains', type=int, default=2, 
        ...
        self.parser.add_argument('--loadSize', type=str, default="[286, 286]", 
            help='scale images to this size')
        self.parser.add_argument('--cropSize', type=str, default="[256, 256]", 
        ...
        self.parser.add_argument('--netD_n_layers', type=int, default=4, 
            help='number of layers to use for netD')
        self.parser.add_argument('--norm', type=str, default='instance', 
            help='instance normalization or batch normalization')
        self.parser.add_argument('--use_dropout_netG', action='store_true', 
            help='insert dropout for the generator')
