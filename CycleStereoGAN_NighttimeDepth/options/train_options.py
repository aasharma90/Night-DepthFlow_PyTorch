...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.isTrain = True
        self.parser.add_argument('--maxdisp', type=int, required=True, 
            help='argument for setting max. disparity')
        self.parser.add_argument('--model_dispnet',  required=True, 
            help='PSMNet_basic or PSMNet_stackhourglass?')
        self.parser.add_argument('--loadmodel_dispnet', required=True, 
            help='path to the pre-trained dispnet model')
        ...
        self.parser.add_argument('--lambda_disprec', type=float, default=0.05, 
            help='weight for disp reconstruction')
